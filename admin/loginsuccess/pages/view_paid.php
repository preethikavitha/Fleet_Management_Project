...
if($conn->connect_error)
    ...
    if(isset($_POST['user_id']))
    {
        ...
        echo $user;
        $sql7="SELECT * FROM insurancename WHERE insurance_id=$user";
    ...
    if(isset($_POST['save'])){
       ...
       $sql5="SELECT * FROM insurancename WHERE insurance_id=$user";
       $result=$conn->query($sql5);
       $row=$result->fetch_assoc();
      
        $sql3="INSERT INTO insurance_history(insurance_id,num_plate_id,date_of_payment,amount_paid,discount) VALUES($user,'$numplate','$date',$amt,$amt1)";
        
        if($conn->query($sql3))
       {
        $sql4="UPDATE insurancename SET ins_date='$date' WHERE insurance_id=$user";
        echo $date;
        $dat = strtotime(date("Y-m-d", strtotime($date)) . " +1 year");
        echo $dat;
        $sql5="UPDATE insurancename SET date='$dat' WHERE insurance_id=$user";
 ...
 <?php if(isset($err))
    ...
    <input type="hidden" value="<?php echo $numplate;?>" name="numplate">
          ...
          <div class="col-md-12">
            ...
            <input type="date" class="form-control bg-light" id="validationDefault03" value="<?php if(isset($row7['date'])) echo $row7['date'];else echo''; ?>" placeholder="Enter Insurance Date" name="date" readonly>
        ...
        <div class="col-md-12">
            <label for="validationDefault05" class="form-label text-dark"><b>Discount Amount</b></label>
            <input type="number" class="form-control bg-light" id="validationDefault05" placeholder="Enter discount amount" name="amt1" required>
            <div class="invalid-feedback">
                Please Provide a discount Amount Paid
        </div>  
        </div>

...
<div class="container-fluid text-light py-3">
 ...
 <center><h4>License Details</h4></center>
 <h5 style="text-align:center">EMPLOYEE ID:<?php echo $_COOKIE['id'];?></h5>
    ...
    <div class="col-md-6 form-group1">
          ...
          <input type="text" class="form-control bg-light" id="LicenseNo" name="license" placeholder="  Enter License Number" required>
      ...
      Please provide data.
        ...
        <div class="col-md-12 text-dark form-group1">
          <label class="form-label text-dark"><b>Category Of License</b></label>
          <br>

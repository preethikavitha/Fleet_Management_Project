...
?>
 ...
 <h4 style="text-align:center">Enter Vehicle's NumberPlate to see Insurance Details</h4>
    ...
    <div class="col-md-6">
      ...
      <div class="col-md-6">
        ...
        <div class="col-md-3">
          <input type="submit" class="btn btn-primary" value="InsuranceDetails" name="save"/>
        </div>

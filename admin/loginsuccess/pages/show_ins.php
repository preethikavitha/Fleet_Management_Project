...
if($conn->connect_error)
    ...
    $model=$row2['model'];
    $sql3="SELECT date_format(date_of_payment,'%d-%m-%Y') as date_of_payment,amount_paid,discount from insurance_history where num_plate_id='$numplate' and insurance_id='$user'";
...
<td><b style="color:black;">PolicyName:  </b><i class="text-primary"><?php echo $policyname;?></i></td>
  ...
  <thead>
    <tr>
      ...
      <th scope="col" class="text-center">Date_of_payment</th>
    ...
    if($result3->num_rows>0)
							{
								...
								{?>
      <tr>
      <td class="text-center"><?php echo $row3['date_of_payment'];?></td>
      <td class="text-center"><?php echo $row3['amount_paid'];?></td>
      <td class="text-center"><?php echo $row3['discount'];?></td></tr>
                 <?php               }}?>

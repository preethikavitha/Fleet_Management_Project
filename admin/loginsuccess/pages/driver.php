			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>Driver Details</b>
						<span  class="float:right" style="margin-right:10px"><a style="float:right" class="btn btn-success btn-block btn-sm col-sm-2 float-right" href="emp1.php" id="new_car">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
</svg> New Driver
</a></span>
<span  class="float:right"><a style="float:right" class="btn btn-danger btn-block btn-sm col-sm-2 float-right" href="empdel.php" id="new_car">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
</svg> Resigned Drivers
</a></span>
					</div>
...
<label for="drop">Entries to show</label>
							...
							if($result->num_rows>0)
							{
								while($row=$result->fetch_assoc())
								{
									...
									<td><?php echo "Drive Vehicles: <b>".$row['category']."</b><br>DriveTime: <b>".$row['drivetime']."</b><br>DrivePlace: <b>".$row['driveplace']."</b>";?></td>
				...
				$.ajax(
					{
						...
						method:"POST",
						data:{'click_search_driver':true,input:input},

...
$sql3 = "select * from hr where bookid=$book_id"; // Corrected the email address
$result3 = $conn->query($sql3);
$row3 = $result3->fetch_assoc();
$noofhours=$row3['no_of_hr'];
$totamt=$row3['hramt'];
...
$sql5="select *from rent_price where num_plate_id='$numplate'";
$result5=$conn->query($sql5);
$row5=$result5->fetch_assoc();
$perhour=$row5['rent_price_per_hour'];
...
class PDF extends FPDF
{
    ...
    function Body($name,$address,$book_id,$book_date,$noofhours,$perhour,$totamt,$drivercharge,$charges,$total,$get_amount)
    {
        $this->SetY(55);
        $this->SetX(10);
      ...
      $this->Cell(40,9,"No of Hours",1,0,"C");
      $this->Cell(30,9,"perhour",1,0,"C");
      $this->Cell(40,9,"Total",1,1,"C");
      $this->SetTextColor(98, 84, 20);
      $this->Cell(80,9,"Rent Price","LR",0,"C");
      $this->Cell(40,9,$noofhours,"R",0,"C");
      $this->Cell(30,9,$perhour,"R",0,"C");
...
$pdf = new PDF("P", "mm", "A4");
$pdf->AddPage();
$pdf->Body($name,$address,$book_id,$book_date,$noofhours,$perhour,$totamt,$drivercharge,$charges,$total,$get_amount); // Call the Body function to output the user details
$pdf->Output();
?>

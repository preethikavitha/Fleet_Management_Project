...
$sql3 = "select * from km where bookid=$book_id"; // Corrected the email address
...
$total=$row4['tot_amt'];
$sql5="select  rent_price_per_km,charges from rent_price where num_plate_id='$numplate'";
$result5=$conn->query($sql5);
$row5=$result5->fetch_assoc();
$perkm=$row5['rent_price_per_km'];
...
class PDF extends FPDF
{
    ...
    function Body($name,$address,$book_id,$book_date,$drivercharge,$adamt,$perkm,$charges,$total,$get_amount)
    {
        $this->SetY(55);
        $this->SetX(10);
      ...
      $this->Cell(40,9,"No of Km",1,0,"C");
      $this->Cell(30,9,"PerKm",1,0,"C");
      $this->Cell(40,9,"Advance Amount",1,1,"C");
      $this->SetTextColor(98, 84, 20);
      $this->Cell(80,9,"Rent Price","LR",0,"C");
      $this->Cell(40,9,'-',"R",0,"C");
      $this->Cell(30,9,$charges,"R",0,"C");
      $this->Cell(40,9,$perkm,"R",1,"C");
...
$pdf = new PDF("P", "mm", "A4");
$pdf->AddPage();
$pdf->Body($name,$address,$book_id,$book_date,$drivercharge,$adamt,$charges,$perkm,$total,$get_amount); // Call the Body function to output the user details
$pdf->Output();
?>
